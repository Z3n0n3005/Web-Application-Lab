...
public class GetThreeParams extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<ul>");
            out.println("<li><b>param1</b>: "+ request.getParameter("param_1") +"</li>");
            out.println("<li><b>param2</b>: "+ request.getParameter("param_2") +"</li>");
            out.println("<li><b>param3</b>: "+ request.getParameter("param_3") +"</li>");
            out.println("</ul>");
            out.println("</body>");
            out.println("</html>");
        }
